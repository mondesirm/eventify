...
const Home = ({ color, strokeWidth, set }: Props) => {
	...
	const Curved = () => (
		<G transform="translate(2.4 2)">
			<Path d="M0,.5H5.815" transform="translate(6.679 13.635)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth} />
			<Path d="M0,11.713c0-5.631.614-5.238,3.919-8.3C5.365,2.246,7.615,0,9.558,0s4.237,2.235,5.7,3.41c3.305,3.065,3.918,2.672,3.918,8.3C19.172,20,17.213,20,9.586,20S0,20,0,11.713Z" transform="translate(0)" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth={strokeWidth} />
		</G>
	)
